...
class Main extends CI_Controller {
	...
	function __construct(){
		...
		$params = array('server_key' => 'SB-Mid-server-f4RtCTgWVXSnVTf2moZud3V0', 'production' => false);
	...
	public function history_pesanan(){
		...
		$data['orders'] = $this->Madmin->get_orders_by_member($dataWhere['idKonsumen']);
		$data['kategori'] = $this->Madmin->get_all_data('tbl_kategori')->result();
		$this->load->view('home/layout/header', $data);
		$this->load->view('home/history_pesanan', $data);
		$this->load->view('home/layout/footer');
	}
	...
	public function rate_order() {
        ...
        if ($idOrder && $rating) {
            ...
            $this->load->model('Madmin');
            $this->Madmin->update('tbl_order', $data, 'idOrder', $idOrder);
        }

        // Redirect ke halaman history pesanan
        redirect('home/history_pesanan');
    }
