        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="<?php echo site_url(); ?>" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">T</span>rendyWear</h1>
                </a>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
					...
					<?php }  else { ?>
                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="<?= site_url('main/history_pesanan')?>" class="nav-item nav-link">History pembelian</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0">
